...
+ (MB_INSTANCETYPE)showHUDAddedTo:(UIView *)view animated:(BOOL)animated {
	MBProgressHUD *hud = [[self alloc] initWithView:view activityKind:UIActivityIndicatorViewStyleWhiteLarge];
	[view addSubview:hud];
	[hud show:animated];
...
- (id)initWithView:(UIView *)view activityKind:(UIActivityIndicatorViewStyle)style {
...
- (id)initWithWindow:(UIWindow *)window {
	return [self initWithView:window activityKind:UIActivityIndicatorViewStyleWhiteLarge];
}
...
- (void)updateIndicators {
	...
	if (mode == MBProgressHUDModeIndeterminate &&  !isActivityIndicator) {
		...
		self.indicator = MB_AUTORELEASE([[UIActivityIndicatorView alloc]
										 initWithActivityIndicatorStyle:activitystyle]);
