...
+(STCoreDataStack*) coreDataStackWithSharedModelName:(NSString *)mname databaseFilename:(NSString*) dbname
{
    ...
    STCoreDataStack* sharedStack = [sharedModelsByNameANdDBName objectForKey:[self sharedNameForModelName:mname dbName:dbname]];
    if( sharedStack == nil )
    {
...
+(STCoreDataStack*) coreDataStackWithModelName:(NSString *)mname databaseFilename:(NSString*) dbname
{
    ...
    STCoreDataStack* cds = [[STCoreDataStack alloc] initWithURL: storeURL
                                                   modelName: mname
...
{
    STCoreDataStack* cds = [[STCoreDataStack alloc] initWithURL:dburl modelName:mname storeType:CDSStoreTypeUnknown] ;
